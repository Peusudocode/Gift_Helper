...
class PchomeSpider():
    ...
    def search_products(self, keyword, max_page=1, shop='全部', sort='精準度', price_min=-1, price_max=-1, is_store_pickup=False, is_ipost_pickup=False):
        """搜尋商品
